...
function renderSleepBarPlot(containerId, svgId, columnId, axisText) {
...
renderSleepBarPlot('.sleep_duration_container', '#sleep_duration_bar_plot', 'Hours', 'Sleep time [hr]')
renderSleepBarPlot('.sleep_duration_container', '#deep_sleep_duration_bar_plot', 'DeepSleep', 'Deep Sleep time [hr]')
renderSleepBarPlot('.sleep_duration_container', '#sleep_cycles_bar_plot', 'Cycles', 'Sleep Cycles')